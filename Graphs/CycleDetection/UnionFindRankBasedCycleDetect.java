...
public class UnionFindRankBasedCycleDetect 
{
	int V, E; 
	Edge[] edge; 
	  
	UnionFindRankBasedCycleDetect(int nV, int nE) 
	{ 
	    V = nV; 
	    E = nE; 
	    edge = new Edge[E]; 
	...
	int isCycle(UnionFindRankBasedCycleDetect  graph) 
	{ 
	    int V = graph.V; 
	    int E = graph.E; 
	...
	int V = 3, E = 3; 
	UnionFindRankBasedCycleDetect  graph = new UnionFindRankBasedCycleDetect (V, E); 
